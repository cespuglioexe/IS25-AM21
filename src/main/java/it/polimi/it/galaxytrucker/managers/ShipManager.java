...
public class ShipManager {
     ...
     */
    public double activateComponent(HashMap<List<Integer>, List<Integer>> componentAndBatteries) throws InvalidActionException, IllegalComponentPositionException {
        double power = 0;
    ...
    public double calculateFirePower(HashMap<List<Integer>, List<Integer>> doubleCannonsAndBatteries) throws InvalidActionException, IllegalComponentPositionException {
    ...
    public int calculateEnginePower(HashMap<List<Integer>, List<Integer>> doubleEnginesAndBatteries) throws InvalidActionException, IllegalComponentPositionException {
        boolean activedAliens = false;
