...
public class ShipCreation {
    public static void createLegalShip1(Player player) {
        ...
        ship.addComponentTile(8, 6, new SingleEngine(List.of(TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.INCOMPATIBLE,TileEdge.SINGLE)));
        ship.addComponentTile(8, 7, new DoubleEngine(List.of(TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.INCOMPATIBLE,TileEdge.SINGLE)));
        ship.addComponentTile(8, 8, new SingleEngine(List.of(TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.INCOMPATIBLE,TileEdge.SINGLE)));
    ...
    public static void createLegalShip2(Player player) {
        ...
        ship.addComponentTile(8, 7, new DoubleEngine(List.of(TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.INCOMPATIBLE,TileEdge.SINGLE)));
        ship.addComponentTile(8, 8, new SingleEngine(List.of(TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.INCOMPATIBLE,TileEdge.SINGLE)));
        ship.addComponentTile(8, 9, new DoubleEngine(List.of(TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.INCOMPATIBLE,TileEdge.SINGLE)));
    ...
    public static void createIllegalShip1(Player player) {
        ...
        ship.addComponentTile(8, 10, new CabinModule(List.of(TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.SINGLE)));
        ship.addComponentTile(9, 9, new CabinModule(List.of(TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.SINGLE)));
    ...
    public static void createIllegalShip2(Player player) {
        ...
        ship.addComponentTile(6, 6, new SingleCannon(List.of(TileEdge.INCOMPATIBLE,TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.SINGLE)));
        // TWO MIMATCHED EDGES
        ship.addComponentTile(6, 7, new DoubleCannon(List.of(TileEdge.INCOMPATIBLE,TileEdge.DOUBLE,TileEdge.SMOOTH,TileEdge.SINGLE)));
        ship.addComponentTile(6, 8, new SingleCannon(List.of(TileEdge.INCOMPATIBLE,TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.SINGLE)));
        ...
        // ALL WRONG EDGED
        ship.addComponentTile(8, 4, new LifeSupport(AlienType.PURPLEALIEN, List.of(TileEdge.SMOOTH,TileEdge.SMOOTH,TileEdge.SMOOTH,TileEdge.SMOOTH)));
        ship.addComponentTile(8, 5, new CabinModule(List.of(TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.SINGLE)));
        ship.addComponentTile(8, 6, new SingleEngine(List.of(TileEdge.SINGLE,TileEdge.UNIVERSAL,TileEdge.INCOMPATIBLE,TileEdge.SINGLE)));
        ship.addComponentTile(8, 8, new SingleEngine(List.of(TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.INCOMPATIBLE,TileEdge.SINGLE)));
        ship.addComponentTile(8, 7, new DoubleEngine(List.of(TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.INCOMPATIBLE,TileEdge.SINGLE)));
    ...
    public static void createIllegalShip4(Player player) {
        ...
        ship.addComponentTile(7, 5, new DoubleCannon(List.of(TileEdge.INCOMPATIBLE,TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.SINGLE)));
        ship.addComponentTile(7, 6, new BatteryComponent(2, List.of(TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.SINGLE)));
        ship.addComponentTile(7, 8, new BatteryComponent(2, List.of(TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.SINGLE)));
        ship.addComponentTile(7, 9, new Shield(Direction.DOWN, List.of(TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.SINGLE,TileEdge.SINGLE)));
